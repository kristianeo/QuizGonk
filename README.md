...
### Working as a team:
We both have had a pleasant experience working on this project as a team. We are proud of the final outcome, thanks to great teamwork and communication.
We have both been invested in this project, and available for each other when needed.
The main difference from working alone is coordinating the different tasks and sharing the same vision for the program to work optimally.
This experience could potentially have been completely different working with someone else.
